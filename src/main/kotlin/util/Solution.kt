...
object Solution {
    ...
    fun run(day: Int, func: () -> Any?, debug: InputType? = null) {
        ...
        println("${ConsoleColors.RESET} expected output:  ${ConsoleColors.RESET}$solution${ConsoleColors.RESET}")
    ...
    fun getInputAsIntArray(): List<Int> {
        return getInputAsText().lines().map { it.toInt() }
    }

    fun getInputAsStringArray(): List<String> {
        return getInputAsText().lines()
    }
